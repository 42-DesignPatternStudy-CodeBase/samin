...
import abstractFactoryPattern.daoFactory.mysqlFactory.MySqlDaoFactory;
import abstractFactoryPattern.daoFactory.oracleFactory.OracleDaoFactory;
import abstractFactoryPattern.productDao.ProductDao;


public class UserInfoClient {
    public static void main(String[] args) throws IOException {
        FileInputStream fis = new FileInputStream("/Users/samin/dev/javadesign/samin/abstractFactoryPattern/db.properties");
